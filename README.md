...
| 데이터셋 명칭 | 활용 목적 및 내용 | 제공 기관 | 비고 |
| :--- | :--- | :--- | :--- |
| **교육부 특수교육 통계** | 연도별 특수교육대상자 수, 학교 배치 현황, 장애 유형 비율 등 현황 분석 자료 활용 | 교육부 | **공공데이터포털** |
| **나이스(NEIS) 교육정보** | 학사일정, 시간표, 급식 정보 등 학교 생활 기본 데이터 연동 | 한국교육학술정보원(KERIS) | **공공데이터포털** |
| **2022 개정 특수교육 성취기준** | 학년별·장애 유형별 성취 목표 및 교수·학습 가이드 데이터 활용 | 교육부 / NCIC | - |
| **특수교육 성취기준 풀(Pool)** | 행동 단위(Task Analysis) 기반의 세부 교육 활동 및 지도 데이터 구축 | 국립특수교육원 | - |
| **커리어넷 직업백과 데이터** | 직업별 핵심 역량 및 진로 정보를 학생 성장 로드맵 설계에 활용 | 한국직업능력연구원 | **공공데이터포털** |
